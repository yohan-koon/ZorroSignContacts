...
import 'package:zorro_sign_contacts/core/components/default_text_field/default_text_field.shimmer.dart';
  ...
  renderSimmer() {
    return Shimmer.fromColors(
        ...
        child: DefaultTextFieldShimmer(
          isVisibleLabel: labelPosition == DefaultTextFieldLabelPosition.top && labelText != null && labelText?.isNotEmpty == true,
        ));
  }
        ...
        decoration: decoration ??
            InputDecoration(
              ...
              focusedBorder: focusedBorder ??
                  OutlineInputBorder(
                      borderSide: const BorderSide(color: Palette.GREEN, width: 1.0),
                      borderRadius: BorderRadius.circular(2.5.w)),
              errorBorder: errorBorder ??
                  OutlineInputBorder(
                      borderSide: const BorderSide(color: Palette.RED, width: 1.0),
                      borderRadius: BorderRadius.circular(2.5.w)),
              border: border ??
                  OutlineInputBorder(
                      borderSide: BorderSide(
                          color: Palette.SLATE_GRAY.withOpacity(0.2), width: 1),
                      borderRadius: BorderRadius.circular(2.5.w)),
              ...
              hintStyle: hintStyle ??
                  Theme.of(context)
                      .primaryTextTheme
                      .bodyText2
                      ?.copyWith(color: Palette.BLACK, fontSize: 14.5.sp),
              floatingLabelBehavior: FloatingLabelBehavior.always,
              isDense: isDense ?? true,
              contentPadding: contentPadding ??
                  EdgeInsets.symmetric(
                      vertical: 3.5.w, horizontal: 4.w), //updated
            ),
        keyboardType: keyboardType,
        textCapitalization: textCapitalization,
        textInputAction: textInputAction ?? TextInputAction.next,
        style: style ?? TextStyle(fontSize: 14.5.sp, color: Palette.BLACK),
